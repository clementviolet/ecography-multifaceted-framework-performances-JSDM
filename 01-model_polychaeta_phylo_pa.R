...
model_polychaeta_phylo_pa <- sampleMcmc(model,
  samples = samples,
  thin = thin,
  transient = transient,
  nChains = nChains,
...
saveRDS(model_polychaeta_phylo_pa, file = paste0("Data/Model_Output/model_polychaeta_phylo_pa_", iter_tot/1E3 , "K_", job_index, ".rds"))
